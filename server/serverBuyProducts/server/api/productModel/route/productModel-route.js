...
export default class ProductModelRoute {
  static init(router) {
    ...
    router.route('/productModel/oneFieldOneAttribute').post(ProductModelController.oneFieldOneAttribute);
                                                         // pagination and searching one field One attribute at a time
